...
| <a name="input_context_properties"></a> [context\_properties](#input\_context\_properties) | Specifies list of context properties used to create a Snowflake User name - this variable conflicts with `context_template` | `list(string)` | <pre>[<br>  "environment",<br>  "name"<br>]</pre> | no |
| <a name="input_context_template_name"></a> [context\_template\_name](#input\_context\_template\_name) | Name of the context template used to create resource name - this variable is used when, `var.context_templates` is set | `string` | `"snowflake-role"` | no |
| <a name="input_context_templates"></a> [context\_templates](#input\_context\_templates) | Map of context templates used for naming conventions - this variable conflicts with `context_properties` | `map(string)` | `{}` | no |
